  ...
  switch (e.currentTarget.name) {
    case "productName":
      if (expresiones.productName.test(e.target.value)) {
        document
          ...
          .classList.remove("main__container-rol-incorrecto");
        document
          .getElementById("div__name")
          .classList.add("main__container-rol-correcto");
        document
          .querySelector("#div__name i")
          .classList.remove("fa-circle-xmark");
        document.querySelector("#div__name i").classList.add("fa-check-circle");
        document
          .querySelector("#div__name .form__input-error")
          .classList.remove("form__input-error-activo");
        campos.productName = true;
      } else {
        document
          .getElementById("div__name")
          .classList.add("main__container-rol-incorrecto");
        document
          .getElementById("div__name")
          .classList.remove("main__container-rol-correcto");
    ...
    case "productDescription":
      if (expresiones.productDescription.test(e.target.value)) {
        document
          .getElementById("div__description")
          .classList.remove("main__container-rol-incorrecto");
        document
          .getElementById("div__description")
          .classList.add("main__container-rol-correcto");
        document
          .querySelector("#div__description i")
          .classList.remove("fa-circle-xmark");
        document
          .querySelector("#div__description i")
          .classList.add("fa-check-circle");
        document
          .querySelector("#div__description .form__input-error")
          .classList.remove("form__input-error-activo");
    ...
    case "productDescriptionLong":
      if (expresiones.productDescriptionLong.test(e.target.value)) {
        document
          .getElementById("div__descriptionLong")
          .classList.remove("main__container-rol-incorrecto");
        document
          .getElementById("div__descriptionLong")
          .classList.add("main__container-rol-correcto");
        document
          .querySelector("#div__descriptionLong i")
          .classList.remove("fa-circle-xmark");
        document
          .querySelector("#div__descriptionLong i")
          .classList.add("fa-check-circle");
        document
          .querySelector("#div__descriptionLong .form__input-error")
          .classList.remove("form__input-error-activo");
    ...
    case "productPrice":
      if (expresiones.productPrice.test(e.target.value)) {
        document
          .getElementById("div__price")
          .classList.remove("main__container-rol-incorrecto");
        document
          .getElementById("div__price")
          .classList.add("main__container-rol-correcto");
        document
          .querySelector("#div__price i")
          .classList.remove("fa-circle-xmark");
        document
          .querySelector("#div__price i")
          .classList.add("fa-check-circle");
        document
          .querySelector("#div__price .form__input-error")
          .classList.remove("form__input-error-activo");
    ...
    case "productStock":
      if (expresiones.productStock.test(e.target.value)) {
        document
          .getElementById("div__stock")
          .classList.remove("main__container-rol-incorrecto");
        document
          .getElementById("div__stock")
          .classList.add("main__container-rol-correcto");
        document
          .querySelector("#div__stock i")
          .classList.remove("fa-circle-xmark");
        document
          .querySelector("#div__stock i")
          .classList.add("fa-check-circle");
        document
          .querySelector("#div__stock .form__input-error")
          .classList.remove("form__input-error-activo");
    ...
    case "productFees":
      if (expresiones.productFees.test(e.target.value)) {
        document
          .getElementById("div__fees")
          .classList.remove("main__container-rol-incorrecto");
        document
          .getElementById("div__fees")
          .classList.add("main__container-rol-correcto");
        document
          .querySelector("#div__fees i")
          .classList.remove("fa-circle-xmark");
        document.querySelector("#div__fees i").classList.add("fa-check-circle");
        document
          .querySelector("#div__fees .form__input-error")
          .classList.remove("form__input-error-activo");
